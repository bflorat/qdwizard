...
public abstract class Screen extends JPanel {
  ...
  /**
   * Called by wizard when the wizard is being canceled. Override this function to
   ...
   * pressed. Override this function to clean up (like stop any threads that this
